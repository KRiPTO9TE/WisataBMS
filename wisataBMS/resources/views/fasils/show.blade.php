...
@endif
				...
				<div class="nav-header">
					...
					<nav id="fh5co-menu-wrap" role="navigation">
						...
						@if(Auth::check()==0)
                            ...
                            <li class="active"><a href="/fasil">Fasilitas</a></li>
		...
		<div class="fh5co-hero">
			...
			<div class="fh5co-cover" data-stellar-background-ratio="0.5" style="background-image: url(/image/{{ $fasil->image }});">
				<div class="desc">
					<div class="container">
						<div class="row">   
							<div class="desc2 animate-box">
								<div class="col-sm-7 col-sm-push-1 col-md-7 col-md-push-1">
									<h1>Fasilitas {{ $fasil->category }}</h1>
									<h2>{{ $fasil->name }}</h2>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
						...
						<p>Kumpulan fasilitas di Banyumas yang siap menunjang liburanmu yang aman dan nyaman!</p>
					</div>
				</div>
				<div class="row">
					...
					<div id="myCarousel" class="carousel slide" data-ride="carousel">
						...
						<div class="item active">
							<img src="/image/{{ $fasil->image }}" alt="(/image/{{ $fasil->image }})" style="width:100%;">
						</div>
						@foreach ($fgambars as $fgambar)
						@if (  "{{ $fgambar->fasilitas_id }}"  == "{{ $fasil->id }}" )     						
						<div class="item">
							<img src="{{asset('image/'. $fgambar->image)}}" alt="{{ $fgambar->image }}" style="width:100%;">
				...
				<div class="modal fade" id="myModal1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
						<div class="modal-dialog" role="document">
							...
							<div class="modal-body">
								...
								<form action="{{ route('fgambars.store') }}" method="POST" enctype="multipart/form-data">

								@csrf
										

								<input type="hidden" id="fasilitas_id" name="fasilitas_id" value="{{ $fasil->id}}">
...
<tr>
	...
	<td><img src="/image/{{ $fgambar->image }}" width="100px" alt=""></td>
	...
	<div id="myModal2" class="modal fade" role="dialog">
		  <div class="modal-dialog">
			...
			<div class="modal-content">
			  ...
			  <form action="{{ route('fgambars.destroy',$fgambar->id) }}" method="POST">
					...
					<div class="row animate-box">
						<div class="col-md-6">
							...
							<ul class="contact-info">
								<li><i class="icon-location-pin"></i>{{ $fasil->alamat }}</li>
								<li><i class="icon-phone2"></i>{{ $fasil->telefon }}</li>
								<li><i class="icon-globe2"></i><a href="http://{{ $fasil->web }}">{{ $fasil->web }}</a></li>
							</ul>
						</div>
						<div class="col-md-6">
...
function initialize() {
  var propertiPeta = {
    center:new google.maps.LatLng({{ $fasil->mapslat }},{{ $fasil->mapslong }}),
    zoom:16,
  ...
  var marker=new google.maps.Marker({
      position: new google.maps.LatLng({{ $fasil->mapslat }},{{ $fasil->mapslong }}),
      map: peta
  });
