            ...
            <div class="row">
				<div class="col-md-10 col-md-offset-1 text-center  animate-box">
				  	<div id="myBtnContainer">
  						...
  						<button class="btn" onclick="filterSelection('ATM & Bank')"> ATM & Bank</button>
  						<button class="btn" onclick="filterSelection('Pendidikan')"> Pusat Pendidikan</button>
  						<button class="btn" onclick="filterSelection('Penginapan')"> Penginapan</button>
  						<button class="btn" onclick="filterSelection('Rumah Sakit & Klinik')"> Rumah Sakit & Klinik</button>
  						<button class="btn" onclick="filterSelection('SPBU')"> SPBU</button>
  						<button class="btn" onclick="filterSelection('Transportasi')"> Transportasi</button>
					</div>
					<br><br>
				</div>
