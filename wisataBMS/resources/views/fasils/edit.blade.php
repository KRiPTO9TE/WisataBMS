 ...
 <div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        ...
        <div class="form-group">
            ...
            <img src="/image/{{ $fasil->image }}" width="150px">
        </div>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-12">
...
-->         <br>
        ...
        <div class="row">
            ...
            <div class="col">
                <div class="md-form md-outline">
                    <strong>Buka:</strong>
                    <input type="time" name="bukday" value="{{ $fasil->bukday }}" id="default-picker" class="form-control" placeholder="Select time">
            ...
            <div class="col">
                <div class="md-form md-outline">
                    <strong>Tutup:</strong>
                    <input type="time" name="ttpday" value="{{ $fasil->ttpday }}" id="default-picker" class="form-control" placeholder="Select time">
    ...
    <strong>Jam Operasional Weekends:</strong>
        <div class="row">
            ...
            <div class="col">
                <div class="md-form md-outline">
                    <strong>Buka:</strong>
                    <input type="time" name="bukend" value="{{ $fasil->bukend }}" id="default-picker" class="form-control" placeholder="Select time">
            ...
            <div class="col">
                <div class="md-form md-outline">
                    <strong>Tutup:</strong>
                    <input type="time" name="ttpend" value="{{ $fasil->ttpend }}" id="default-picker" class="form-control" placeholder="Select time">
    ...
    <div class="row">
        ...
        <div class="col">
            <div class="form-group">
                ...
                <input type="text" id="map-search" name="alamat" value="{{ $fasil->alamat }}" class="form-control" placeholder="Cari alamatnya disini">
                <br> <br>
                <label for="">Lat: <input type="text" name="mapslat" value="{{ $fasil->mapslat}}" class="latitude"></label>
                <label for="">Long: <input type="text" name="mapslong" value="{{ $fasil->mapslong}}" class="longitude"></label>
            </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="input-group mb-3">
            ...
            <input type="text"  class="form-control" name="web" value="{{ $fasil->web}}" id="basic-url" aria-describedby="basic-addon3">
        </div>
