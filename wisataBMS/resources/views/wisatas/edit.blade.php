 ...
 <div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        ...
        <div class="form-group">
            ...
            <img src="/image/{{ $wisata->image }}" width="150px">
        </div>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-12">
...
-->         <br>
        ...
        <div class="row">
            ...
            <div class="col">
                <div class="md-form md-outline">
                    <strong>Buka:</strong>
                    <input type="time" name="bukday" value="{{ $wisata->bukday }}" id="default-picker" class="form-control" placeholder="Select time">
            ...
            <div class="col">
                <div class="md-form md-outline">
                    <strong>Tutup:</strong>
                    <input type="time" name="ttpday" value="{{ $wisata->ttpday }}" id="default-picker" class="form-control" placeholder="Select time">
    ...
    <strong>Jam Operasional Weekends:</strong>
        <div class="row">
            ...
            <div class="col">
                <div class="md-form md-outline">
                    <strong>Buka:</strong>
                    <input type="time" name="bukend" value="{{ $wisata->bukend }}" id="default-picker" class="form-control" placeholder="Select time">
            ...
            <div class="col">
                <div class="md-form md-outline">
                    <strong>Tutup:</strong>
                    <input type="time" name="ttpend" value="{{ $wisata->ttpend }}" id="default-picker" class="form-control" placeholder="Select time">
    ...
    <div class="row">
        ...
        <div class="col">
            <div class="form-group">
                ...
                <input type="text" id="map-search" name="alamat" value="{{ $wisata->alamat }}" class="form-control" placeholder="Cari alamatnya disini">
                <br> <br>
                <label for="">Lat: <input type="text" name="mapslat" value="{{ $wisata->mapslat}}" class="latitude"></label>
                <label for="">Long: <input type="text" name="mapslong" value="{{ $wisata->mapslong}}" class="longitude"></label>
            </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="number" name="tktaday" value="{{ $wisata->tktaday}}" class="form-control" aria-label="Amount (to the nearest dollar)">
            ...
            <strong>Dewasa:</strong>
                <div class="input-group mb-3">
                    ...
                    <input type="number" name="tktdday" value="{{ $wisata->tktdday}}" class="form-control" aria-label="Amount (to the nearest dollar)">
        ...
        <div class="row">
            ...
            <strong>Anak Anak:</strong>
                <div class="input-group mb-3">
                    ...
                    <input type="number" name="tktaend" value="{{ $wisata->tktaend}}" class="form-control" aria-label="Amount (to the nearest dollar)">
            ...
            <strong>Dewasa:</strong>
                <div class="input-group mb-3">
                    ...
                    <input type="number" name="tktdend" value="{{ $wisata->tktdend}}" class="form-control" aria-label="Amount (to the nearest dollar)">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="input-group mb-3">
            ...
            <input type="text"  class="form-control" name="web" value="{{ $wisata->web}}" id="basic-url" aria-describedby="basic-addon3">
        </div>
