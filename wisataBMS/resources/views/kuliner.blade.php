			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
						<h3>Kuliner</h3>
						<p>Daftar kumpulan Kuliner di Kabupaten Banyumas dari Kuliner Tradisional sampai kuliner Modern yang siap untuk menemani liburanmu!</p>
					</div>
				</div>
			</div>
            <div class="row">
