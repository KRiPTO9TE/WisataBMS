...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<title>registrasi | Klinthung Banyumas</title>
	...
	<link rel="stylesheet" href="css/stylelrr.css">
...
<div class="container">
    <div class="row justify-content-center">
        <div class="center">
            <div class="card">
                <h1 class="centerup">{{ __('Register') }}</h1>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <strong>Sudah memiliki akun? <a href="/login">Login.</a></strong>
